            ...
            <div class="participate-box">
                ...
                <?php if ($es_creador): ?>
                    ...
                    <p class="owner-message">
                        No podés elegir números ni participar
                        en una rifa que creaste.
                    </p>


                    <a
                        href="administrar_rifa.php?id=<?php echo $id_rifa; ?>"
